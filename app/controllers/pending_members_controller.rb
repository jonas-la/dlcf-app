class PendingMembersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pending_member.save
        format.html { redirect_to new_admin_session_url, notice: "Pending member was successfully created." }
  ...
  def update
    respond_to do |format|
      if @pending_member.update(pending_member_params)
        format.html { redirect_to pending_member_url(@pending_member), notice: "Pending member was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pending_members_url, notice: "Pending member was successfully destroyed." }
